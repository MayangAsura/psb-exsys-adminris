        ...
        <section className="bg-purple-900">
            <div className="px-0 py-20 mx-auto max-w-7xl sm:px-4">
                <div>
                            ...
                            <table className="table table-striped table-bordered table-head-bg-primary" style="width:100%;">
                              ...
                              {data.map( (e, index) => (
                                ...
                                <tr>
                                  ...
                                  <td style="width: 97%;">{nl2br(e.question)} </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    {options.map(() => (
                                      <label className="mb-0 pr-5" style="white-space: normal!important;">
                          ...
                          <button type="submit" name="submit" id="mySubmit" className="btn btn-primary">Kirim Hasil</button>
                        </div>
