...
// export default SEExam = ({id, appl_id, started_at}) => {
...
//       }else{
//         dispatch(openModal({title : "Gagal Menyimpan Ujian", bodyType : MODAL_BODY_TYPES.CONFIRMATION.MODAL_SUCCESS, 
//                 extraObject : { message : 'Data ujian gagal tersimpan', type: CONFIRMATION_MODAL_CLOSE_TYPES.LOGIN_SUCCESS}}))
//       }
//     }
//     if(!qid){
//       const { data, error } = await supabase
