...
const UniformDetail = () => {
  ...
  const [uniformData, setUniformModel] = useState([])
  ...
  const options = [
    ...
    const getUniformModels = async (id) => {
        let { data: school_uniform_models, error } = await supabase
                        .from('school_uniform_models')
                        .select('*, schools!inner(school_name), admissions_ays(academic_year)')
                        .is('deleted_at', null)
                        .eq('id', id)

                        if(school_uniform_models){
                            setUniformModel(school_uniform_models)
                        }

    }
//   const [uniformData] = useState({
//     namaModel: "Seragam Siswa SD Putih-Biru",
//     gambarModel: "/api/placeholder/300/400",
//     jenisKelamin: "Laki-Laki",
//     ukuran: [
//       { sizeKey: "S", itemSize: "28", quantity: 15 },
//       { sizeKey: "M", itemSize: "30", quantity: 20 },
//       { sizeKey: "L", itemSize: "32", quantity: 18 },
//       { sizeKey: "XL", itemSize: "34", quantity: 12 }
//     ],
//     jenjang: "SD",
...
//   });
  ...
  return (
    ...
    <div className="bg-base-200">
            <TabHeaderP id = {id} options={options} activeKey='Detail'  />
                            ...
                            {/* <div>
                                ...
                                <div className="w-full flex flex-col md:flex-row gap-y-52 gap-x-52 md:gap-y-064">
                                    <div className="flex flex-col gap-y-2 w-full"><div className="css-4o3x93">
                                        <p className=" css-zuhd6s">Jenjang</p>
                                        </div>
                                    <div className="css-4o3x93"><p className="w-fit h-fit font-semibold css-1bq9ewv">{uniformData.schools?.school_name } </p></div>
                                    </div>
                                    <div className="flex flex-col gap-y-2 gap-x-52 w-full"><div className="css-4o3x93">
                                        <p className=" css-zuhd6s">Tahun Ajaran</p>
                                        </div><div className="css-4o3x93">
                                        <p className="w-fit h-fit font-semibold css-zuhd6s">{uniformData.admissions_ays?.academic_year} </p></div>
                                    </div>
                                </div>
                                ...
                                <div>
               <h2 className="text-lg font-semibold text-gray-700 mb-4">Detail Ukuran dan Kuantitas</h2>
               <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
          <thead>
            <tr className="bg-gray-100">
              <th className="py-3 px-4 text-left font-semibold text-gray-700 border-b">Size</th>
              {/* {Object.keys(uniformData.xs).map(measurement => (
                <th key={measurement} className="py-3 px-4 text-center font-semibold text-gray-700 border-b">
                  {measurement}
                </th>
              ))} */}
            </tr>
          ...
          <tbody>
            {Object.entries(uniformData?.model_size_chart).map(([size, measurements]) => (
              <tr 
                key={size} 
                className={`transition-colors 
                    ${
                  selectedSize === size ? 'bg-indigo-50' : 'hover:bg-gray-50'
                }
                `
            }
              >
                <td className="py-3 px-4 font-medium text-gray-800 border-b">
                  {size.toUpperCase()}
                  {selectedSize === size && (
                    <span className="ml-2 text-xs bg-indigo-600 text-white px-2 py-1 rounded-full">Selected</span>
                  )}
                </td>
                {Object.entries(measurements).map(([key, value]) => (
                  <td key={key} className="py-3 px-4 text-center border-b">
                    {value} cm
                  </td>
                ))}
              </tr>
               ...
               {/* <div className="overflow-x-auto">
                 <table className="min-w-full divide-y divide-gray-200">
                   ...
                   <tbody className="bg-white divide-y divide-gray-200">
                     {uniformData.model_size_chart.map((size, index) => (
                                        <tr key={index}>
                                            <td className="px-4 py-3 whitespace-nowrap">
                                            <div className="px-3 py-2 bg-blue-50 text-blue-700 rounded-md text-center font-medium">
                                                {size.sizeKey}
                                            </div>
                                            </td>
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap">
                                            <div className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-center">
                                                {size.quantity} pcs
                                            </div>
                                            </td>
                                        </tr>
    ...
    //         <h1 className="text-2xl font-bold">Detail Seragam</h1>
    //         <p className="text-indigo-100">Informasi lengkap seragam sekolah</p>
    //       </div>

    //       <div className="p-6 space-y-6">
    //         {/* Nama Model dan Gambar */}
    //         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    //           <div>
    //             <h2 className="text-lg font-semibold text-gray-700 mb-2">Nama Model</h2>
    //             <div className="px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
    //               <p className="text-gray-800">{uniformData.namaModel}</p>
    //             </div>
    //           </div>
              
    //           <div>
    //             <h2 className="text-lg font-semibold text-gray-700 mb-2">Gambar Model</h2>
    //             <div className="flex justify-center px-6 py-10 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
    //               <div className="text-center">
    //                 <div className="mx-auto h-40 w-40 bg-gray-200 rounded-lg flex items-center justify-center mb-4">
    //                   <span className="text-gray-500 text-sm">Pratinjau Gambar</span>
    //                 </div>
    //                 <p className="text-xs text-gray-500 mt-1">Seragam {uniformData.namaModel}</p>
    //               </div>
    //             </div>
    //           </div>
    //         </div>
    ...
    //         {/* Jenis Kelamin */}
    //         <div>
    //           <h2 className="text-lg font-semibold text-gray-700 mb-4">Jenis Kelamin</h2>
    //           <div className="px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
    //             <p className="text-gray-800">{uniformData.jenisKelamin}</p>
    //           </div>
    //         </div>
    ...
    //               </thead>
    //               <tbody className="bg-white divide-y divide-gray-200">
    //                 {uniformData.ukuran.map((size, index) => (
    //                   <tr key={index}>
    //                     <td className="px-4 py-3 whitespace-nowrap">
    //                       <div className="px-3 py-2 bg-blue-50 text-blue-700 rounded-md text-center font-medium">
    //                         {size.sizeKey}
    ...
    //         {/* Jenjang dan Tahun Ajaran */}
    //         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    //           <div>
    //             <h2 className="text-lg font-semibold text-gray-700 mb-2">Jenjang</h2>
    //             <div className="px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
    //               <p className="text-gray-800">{uniformData.jenjang}</p>
    //             </div>
    //           </div>
              
    //           <div>
    //             <h2 className="text-lg font-semibold text-gray-700 mb-2">Tahun Ajaran</h2>
    //             <div className="px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
    //               <p className="text-gray-800">{uniformData.tahunAjaran}</p>
    //             </div>
    //           </div>
    //         </div>
    ...
    //           <h3 className="text-lg font-semibold text-blue-800 mb-2">Informasi</h3>
    //           <p className="text-blue-700">
    //             Data seragam ini hanya dapat dilihat dan tidak dapat diubah melalui halaman ini.
    //             Untuk mengubah data, silakan gunakan halaman edit seragam.
    //           </p>
    //         </div> */}
    //       </div>
    //     </div>
