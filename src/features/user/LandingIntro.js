    ...
    return(
        <div className="hero min-h-full rounded-l-xl bg-base-200">
            <div className="hero-content py-12">
              ...
              <h1 className='text-3xl text-center font-bold '><img src="/logo.png" className="w-12 inline-block mr-2 mask mask-circle" alt="dashwind-logo" />PSB Admin Rabbaanii</h1>
