...
import { addAdmissionAys, addAdmissionSchool } from "../../../services/api/admissions"
...
function AddAcademicYearModalBody({closeModal, extraObject}){
    ...
    const saveAdmissionSchool = async () => {
        ...
        // else{
            ...
            // }
            setAdmissionSchool({...addAdmissionSchool, admission_id: 'e63830b4-c751-4714-9279-fd57c4be5f10'})
            console.log(admissionSchool)
            
            const response = await addAdmissionAys({newAdmissionAys: admissionSchool})
    ...
    return(
        <>
            ...
            {/* <SelectBox 
                            labelTitle="Admission"
                            options={admissionOptions}
                            placeholder="Pilih Admission"
                            containerStyle="w-72"
                            nameInput="school_id"
                        ...
                        /> */}
            <InputText labelTitle="TA." registerName="academic_year" nameInput="academic_year" placeholder="2026/2027" updateFormValue={updateFormValue}/>                        
            ...
            <ToogleInput labelTitle="Status" nameInput="status" defaultValue="false" updateType="admission_status" containerStyle="flex flex-grow justify-between item-center mt-5" updateFormValue={updateFormValue}/>
...
export default AddAcademicYearModalBody