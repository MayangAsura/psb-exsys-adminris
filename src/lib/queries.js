...
// import { scheduleSchema } from "../features/schedules/create";
...
//           ? advancedWhere
//           : and(
//               input.title ? ilike(scheduleSchema.title, `%${input.title}%`) : undefined,
//               input.status.length > 0
//                 ? inArray(tasks.status, input.status)
//                 : undefined,
//               input.priority.length > 0
//                 ? inArray(scheduleSchema.priority, input.priority)
//                 : undefined,
//               input.estimatedHours.length > 0
//                 ? and(
//                     input.estimatedHours[0]
//                       ? gte(scheduleSchema.estimatedHours, input.estimatedHours[0])
//                       : undefined,
//                     input.estimatedHours[1]
//                       ? lte(scheduleSchema.estimatedHours, input.estimatedHours[1])
//                       : undefined,
//                   )
//                 : undefined,
...
//   )();
// }
// export async function getAllQuestionBanks(input) {
//   return await unstable_cache(
//     async () => {
//       try {
//         const offset = (input.page - 1) * input.perPage;
...
// export async function getQBMaleCounts() {
...
//   )();
// }
// export async function getQBFemaleCounts() {
//   return unstable_cache(
//     async () => {
//       try {
//         return await db
